...
// option 1
const result_one = inventors.filter(function(inventor){
  return inventor.year < 1600 && inventor.year > 1499;
});
// option 2 -- cleaner
const result = inventors.filter(inventor => inventor.year < 1600 && inventor.year > 1499);
...
// option 1
const result__two = inventors.map(function(inventor){
  return inventor.first + ' ' + inventor.last;
});

// option 2 -- cleaner
const result_two = inventors.map(inventor => `${inventor.first} ${inventor.last}`);
...
// const result_three = inventors.sort(function(inventor){
